...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        if prev_station_id is not None:
            print(f" station_id.: {self.station_id},  train_id.: {train.train_id},    train_status.: {train.status},")
            print(f" direction .: {direction}, prev_station_id.: {prev_station_id}, prev_direction.: {prev_direction}")
